        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <AnimatedSection className="mb-16">
            ...
            <p className="text-[#5C4A2A] leading-relaxed mb-4">
              On July 1, 2022, Prof. Toyin Tofade became the 10th President of Albany College of Pharmacy and Health Sciences and the first Black woman to hold that office in the college&apos;s 143-year history.
            </p>
            <p className="text-[#5C4A2A] leading-relaxed mb-4">
