...
const publications = [
  ...
  {
    title: "Steps forward for the International Pharmaceutical Federation (FIP) Academic Pharmacy Section: President's message",
    year: "2022",
    journal: "FIP Academic Pharmacy Section",
    link: "https://www.researchgate.net/publication/363693735_Steps_forward_for_the_International_Pharmaceutical_Federation_FIP_Academic_Pharmacy_Section_President's_message",
  },
]
              ...
              <AnimatedSection key={index} animation="fade-in-up" delay={index * 50}>
                ...
                >
                  <div className="flex gap-4 items-start">
                    ...
                    <ExternalLink className="w-5 h-5 text-[#C6993A] flex-shrink-0 opacity-0 group-hover:opacity-100 transition-opacity" />
                  </div>
                </Link>
              </AnimatedSection>
            ))}
